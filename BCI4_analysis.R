...
ggsave(plot = gc, filename = paste0(local_path,"figures/",
                  "Fig3_wind_risk_vs_size_per_species.png"),height = 6, width = 6)
...
ggsave(plot = gc, filename = paste0(local_path,"figures/",
                      "Fig4_wind_risk_vs_slenderness_and_exposure.png"),dpi=600,height = 6, width = 6)
...
# Make a little function to diplay model results quickly
